...
export const GREEK = "alpha|beta|gamma|Gamma|delta|Delta|epsilon|varepsilon|zeta|theta|Theta|vartheta|iota|kappa|lambda|Lambda|sigma|Sigma|upsilon|Upsilon|omega|Omega";
export const SYMBOL = "infty|sum|prod|lim|pm|mp|dots|nabla|times|cdot|parallel|equiv|neq|geq|leq|gg|ll|sim|simeq|propto|leftrightarrow|to|mapsto|implies|impliedby|cap|cup|in|notin|setminus|subseteq|supseteq|emptyset|exists";

export interface AutoSnippet {
...
export const LATEX_SNIPPETS: AutoSnippet[] = [
    // Math mode
    ...
    {trigger: "Ome", replacement: "\\Omega", options: "mA"},
    {trigger: "upt", replacement: "{\\Large \\uptau}", options: "mA"},

    // Groups n' shit
    {trigger: /gr[a-zA-Z]/, replacement: "\\mathbb{[[0]]}", options: "mA"},

    // Text environment
    {trigger: "text", replacement: "\\text{$0}$1", options: "mA"},
    {trigger: "\"", replacement: "\\text{$0}$1", options: "mA"},

    // Auto Fraction (Latex Suite standard added for you)
    {trigger: /([A-Za-z0-9_]+)\//, replacement: "\\frac{[[0]]}{$0}$1", options: "rmA", description: "Auto fraction for words/numbers"},
    {trigger: /\(([^()]+)\)\//, replacement: "\\frac{[[0]]}{$0}$1", options: "rmA", description: "Auto fraction for parentheses"},
    ...
    {trigger: "Vmat", replacement: "\\begin{Vmatrix}\n$0\n\\end{Vmatrix}", options: "MA"},
    {trigger: "amat", replacement: "\\left(\\begin{array}{$0}\n$1\n\\end{array}\\right)", options: "MA"},
    ...
    {trigger: "Vmat", replacement: "\\begin{Vmatrix}$0\\end{Vmatrix}", options: "nA"},
    {trigger: "amat", replacement: "\\left(\\begin{array}{$0}$1\\end{array}\\right)", options: "nA"},
    {trigger: "matrix", replacement: "\\begin{matrix}$0\\end{matrix}", options: "nA"},
    {trigger: "cases", replacement: "\\begin{cases}\n$0\n\\end{cases}", options: "mA"},
    {trigger: "align", replacement: "\\begin{align}\n$0\n\\end{align}", options: "mA"},
    {trigger: "array", replacement: "\\begin{array}{$0}\n$1\n\\end{array}", options: "MA"},
    {trigger: "array", replacement: "\\begin{array}{$0}$1\\end{array}", options: "nA"},
    ...
    {trigger: "aabs", replacement: "\\left| $0 \\right|$1", options: "mA"},
    ...
    {trigger: /iden(\d)/, replacement: (match: RegExpMatchArray) => {
